...
(function() {
  ...
  // Storage key for validation state
  var STORAGE_KEY = 'bops-validation-state';
  ...
  /**
   * Get validation state from localStorage
   */
  function getState() {
    try {
  ...
  function saveState(state) {
    try {
      ...
      console.warn('Could not save validation state');
    }
  }
  ...
  /**
   * Reset all validation state (useful for testing)
   */
  function resetState() {
