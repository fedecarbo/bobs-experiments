/**
 * Content Loader for Assessment Workflow
...
(function() {
  ...
  var ContentLoader = {
    ...
    updateSidebarCurrent: function(url) {
      ...
      // The AssessmentSidebar component handles current page detection automatically
      if (window.AssessmentSidebar) {
        window.AssessmentSidebar.refresh();
    ...
    updatePageTitle: function(url) {
      ...
      var titleMap = {
        'index': 'Assessment Sidebar Concept v1',
        'check-application-details': 'Check application details - Assessment',
        'check-consultees-consulted': 'Check consultees consulted - Assessment',
        'check-site-history': 'Check site history - Assessment',
        'site-visit': 'Site visit - Assessment',
        'meeting': 'Meeting - Assessment',
        'site-description': 'Site description - Assessment',
        'planning-considerations-and-advice': 'Planning considerations and advice - Assessment',
        'suggest-heads-of-terms': 'Suggest heads of terms - Assessment',
        'summary-of-advice': 'Summary of advice - Assessment',
        'choose-application-type': 'Choose application type - Assessment',
        'check-and-add-requirements': 'Check and add requirements - Assessment',
        'review-and-submit-pre-application': 'Review and submit pre-application - Assessment'
      };

      var title = titleMap[filename] || 'Assessment';
    ...
    reinitializeComponents: function() {
      ...
      // Reinitialize assessment controls
      if (window.AssessmentUtils && window.AssessmentUtils.reinit) {
        window.AssessmentUtils.reinit();
      }
    },
